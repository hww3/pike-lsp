...
describe('Navigation Edge Cases', { timeout: 30000 }, () => {
  ...
  describe('Multi-Document Search', () => {
    it('should search across multiple documents', () => {
      ...
      documents.set(
        'file:///a.pike',
        TextDocument.create('file:///a.pike', 'pike', 1, 'int x = 5;')
      );
      documents.set(
        'file:///b.pike',
        TextDocument.create('file:///b.pike', 'pike', 1, 'int y = x + 1;')
      );
      documents.set(
        'file:///c.pike',
        TextDocument.create('file:///c.pike', 'pike', 1, 'return x;')
      );
