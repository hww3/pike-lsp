...
export function registerEditingHandlers(
    ...
    const { registerCompletionHandlers } = require('./completion.js');
    const { registerSignatureHelpHandler } = require('./signature-help.js');
    const { registerRenameHandlers } = require('./rename.js');
